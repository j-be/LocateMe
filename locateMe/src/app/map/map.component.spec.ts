...
describe('MapComponent', () => {
  ...
  beforeEach(() => {
    ...
    // Mock the map size to ensure Leaflet returns a realistic size in jsdom.
    vi.spyOn(component['map']!, 'getSize').mockImplementation(() => point(800, 600));
  });
  ...
  it('should pan to both', () => {
    ...
    expect(component['map']?.getCenter().lat).toBeCloseTo(26, 0);
    expect(component['map']?.getCenter().lng).toBeCloseTo(35, 0);
